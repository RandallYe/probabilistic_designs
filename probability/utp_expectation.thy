...
begin
  lift_definition less_eq_prob :: "prob \<Rightarrow> prob \<Rightarrow> bool" is "less_eq" .
  lift_definition less_prob :: "prob \<Rightarrow> prob \<Rightarrow> bool" is "less" .
  lift_definition zero_prob :: prob is 0 by auto
  lift_definition one_prob :: prob is 1 by auto
  lift_definition times_prob :: "prob \<Rightarrow> prob \<Rightarrow> prob" is "times"
