...
\input{utp_prob_rel_lattice_dwta}
\input{utp_prob_rel_lattice_monty_hall}
\input{utp_prob_rel_lattice_robot_localisation}
\input{utp_prob_rel_lattice_coin}
\input{utp_prob_rel_lattice_dices}
